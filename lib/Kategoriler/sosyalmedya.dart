...
import 'package:bitirme_webscraping/sosyalmedya_scraping.dart';
import 'package:flutter/material.dart';

class SosyalMedyaPage extends StatefulWidget {
  const SosyalMedyaPage({super.key});

  @override
  _SosyalMedyaPageState createState() => _SosyalMedyaPageState();
}

class _SosyalMedyaPageState extends State<SosyalMedyaPage> {
  final SosyalMedyaWebScraping webScraping = SosyalMedyaWebScraping();
  int _currentPage = 1;
  ...
  Future<void> _fetchData(int startPage, int endPage) async {
    ...
    try {
      List<Haber> newData =
          await webScraping.extractSosyalMedyaData(startPage, endPage);
      setState(() {
