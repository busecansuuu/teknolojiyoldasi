...
import 'package:bitirme_webscraping/kvkk_scraping.dart';
...
class _KVKKPageState extends State<KVKKPage> {
  final KVKKWebScraping webScraping = KVKKWebScraping();
  int _currentPage = 1;
  ...
  Future<void> _fetchData(int startPage, int endPage) async {
    ...
    try {
      List<Haber> newData =
          await webScraping.extractKVKKData(startPage, endPage);
      setState(() {
