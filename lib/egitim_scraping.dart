...
class EgitimWebScraping {
  final String baseUrl = "https://www.teknolojiyoldasi.com/kategori/egitim/";

  Future<List<Haber>> extractEgitimData(int startPage, int endPage) async {
    List<Haber> haberler = [];
