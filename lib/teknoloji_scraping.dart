...
class TeknolojiWebScraping {
  final String baseUrl = "https://www.teknolojiyoldasi.com/kategori/teknoloji/";

  Future<List<Haber>> extractTeknolojiData(int startPage, int endPage) async {
    List<Haber> haberler = [];
