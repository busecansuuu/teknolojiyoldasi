...
class SosyalMedyaWebScraping {
  final String baseUrl =
      "https://www.teknolojiyoldasi.com/kategori/sosyal-medya/";

  Future<List<Haber>> extractSosyalMedyaData(int startPage, int endPage) async {
    List<Haber> haberler = [];
