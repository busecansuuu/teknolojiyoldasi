...
class KVKKWebScraping {
  final String baseUrl =
      "https://www.teknolojiyoldasi.com/kategori/kisiselverilerinkorunmasi/";

  Future<List<Haber>> extractKVKKData(int startPage, int endPage) async {
    List<Haber> haberler = [];
